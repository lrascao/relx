...
cp --recursive --force ../_build/test/logs/* ${TRAVIS_JOB_NUMBER}
...
echo "* $TEST_RESULT_EMOJI [#${TRAVIS_JOB_NUMBER} (OTP ${TRAVIS_OTP_RELEASE})](http://lrascao.github.io/relx/${TRAVIS_JOB_NUMBER})\
 [${TRAVIS_COMMIT}](https://github.com/lrascao/relx/${TRAVIS_COMMIT})" >> README.md
echo >> README.md
...
git push --quiet --force origin travis-build > /dev/null 2>&1
